function [params, flag, err, output] = fit(funName,params,freeList,varargin)
...
[vars, fval, flag, output] = fminsearch('fitFunction',vars,options,funName,params,freeList,varargin);
